...
[Chapter03 - variables-in-playbooks](https://subscription.packtpub.com/book/cloud-and-networking/9781789954333/3/ch03lvl1sec17/variables-in-playbooksr)


* 변수는 set_fact 로 이름과 값을 입력함.
...
* 기본 모듈 중 setup로 대상의 상세한 정보를 가져올 수 있음.
...
<details>
<summary>  전체 실행 결과 보기 접기/펼치기</summary>
...
>  * 네임스페이지 기반으로 만들어지는 것이라 컨테이너 내부 명령어로는 변경할 수 없음
...
* **ESTABLISH SSH CONNECTION FOR USER: None** - SSH 사용자 이름이 없음
  * ansible 설치 후 아무것도 설정되어 있지 않은 상태 였음


https://github.com/zasfe/TIL/blob/dc3ad930b63f1d3d4459f44fcf0cd199e8fccc9e/Automation/z_example_error_ESTABLISH_SSH_CONNECTION_FOR_USER_None.sh#L25-L28
